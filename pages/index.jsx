  ...
  return (
    <>
      ...
      <img width="500" src="/img/bck.png" />
       ...
       Deniz Bey Bot yeniliklere açık v14 sürümlü bir bottur.Botun temel özellikleri ticket,müzik,moderasyon ve eylence botudur. 
	  </p>
...
BOTU BİLDİR</a>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-y-12 lg:gap-y-0 lg:gap-x-12 py-24">
          <div className="col-span-4">
            <p className="text-white text-4xl font-bold" dangerouslySetInnerHTML={{ __html:" DENİZ BEY" }} />
            <p className="text-white text-md font-medium text-gray-500/75" dangerouslySetInnerHTML={{ __html: "YENİLİKÇİ  ÖZGÜR BİR TASARIMA VE KODLAMAYA AİT BİR BOT " }}/>
